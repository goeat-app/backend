...
- `EMULATOR_HOST=localhost:9099` (conecta ao Auth Emulator)
...
| `EMULATOR_HOST`       | Endereço do Firebase Auth Emulator   | `localhost:9099`   |
...
Certifique-se de que `EMULATOR_HOST=localhost:9099` está configurado e Firebase Emulator está rodando:
...
2. `EMULATOR_HOST=localhost:9099` está configurado no seu `.env`
